...
% More information about SVT can be found in the paper:    Cai, Jian-Feng and Cand¨¨s, Emmanuel J and Shen, Zuowei, 
%    "A singular value thresholding algorithm for matrix completion",   SIAM Journal on optimization, 2010.
%% Inputs:
